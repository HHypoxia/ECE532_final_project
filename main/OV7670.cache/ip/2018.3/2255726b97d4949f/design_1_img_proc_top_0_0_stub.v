...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(i_clk, someport, i_data_valid, pixel_in, 
  o_data_valid, o_waddr, o_data)
/* synthesis syn_black_box black_box_pad_pin="i_clk,someport,i_data_valid,pixel_in[11:0],o_data_valid,o_waddr[17:0],o_data[11:0]" */;
  input i_clk;
  input someport;
  input i_data_valid;
  input [11:0]pixel_in;
